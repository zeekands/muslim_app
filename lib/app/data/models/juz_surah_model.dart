class JuzSurahDetail {
  int? code;
  String? status;
  String? message;
  Data? data;

  JuzSurahDetail({this.code, this.status, this.message, this.data});

  JuzSurahDetail.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    juzStartInfo = json['juzStartInfo'].toString();
    juzEndInfo = json['juzEndInfo'].toString();
    totalVerses = json['totalVerses'].toString();
    if (json['verses'] != null) {
      verses = <Verses>[];
